...
from Proyecto1.views import saludar, segunda_vista, dia_de_hoy, saludo_con_nombre, calcula_anio_nacimiento, probandoHtml
...
urlpatterns = [
    ...
    path('calculaanio/<edad>', calcula_anio_nacimiento),
